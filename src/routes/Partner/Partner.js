...
=======
      <Content>
        <QueueAnim component="ul" className="partner" type={'bottom'}>
          {[
            <li key={'li1'}><QueueAnim type={'bottom'} className="item"> {[
              <div key={'li1div1'} className="item-logo"><img src={'http://odp22tnw6.bkt.clouddn.com/nanjin.jpg'}/>
              </div>,
              <div key={'li1div2'}><p>
                南京文交所钱币邮票交易中心有限公司聚集国内钱币邮票界专业团队整合优质资源打造的钱币邮票交易平台。钱币邮票交易中心推行的交易模式是创新的实物挂牌模式，是把发展文化产业与金融创新结合起来。
...
=======
                  <div className="item-logo" key={'li2div1'}><img src={'http://odp22tnw6.bkt.clouddn.com/angui.png'}/>
                  </div>,
                  <div key={'li2div2'}><p> 安徽安贵大宗商品电子商务现货市场有限公司成
>>>>>>> 736d08c9f7127501f22e1c8e483078b9b4637ab0
...
=======
                  <div className="item-logo" key={'li3div1'}><img src={'http://odp22tnw6.bkt.clouddn.com/3.0logo.jpg'}/>
                  </div>,
                  <div key={'li3div2'}><p>
                    “叁点零收藏品交易中心”是由杭州3.0易货交易所与上海英泓实业有限公司联合发起设立的，以收藏品为主要交易品种的综合性专业文化交易机构。杭州叁点零易货交易所是国际贸易协会(IRTA)中国唯一I的懂事会成员，
>>>>>>> 736d08c9f7127501f22e1c8e483078b9b4637ab0
